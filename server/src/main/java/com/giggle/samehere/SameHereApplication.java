...
class TestDummy {
    ...
    public void setUp() {
        ...
        itemRepository.save(Item.multipleChoicesQuestion("MBTI", new ItemChoices("INTP", "ENFP", "ESTJ", "ENFJ")));
        itemRepository.save(Item.shortQuestion("더미"));
        itemRepository.save(Item.shortQuestion("한줄소개"));
        itemRepository.save(Item.multipleChoicesQuestion("좋아하는계절", new ItemChoices("겨울", "봄", "여름", "가을")));
        itemRepository.save(Item.multipleChoicesQuestion("좋아하는음식", new ItemChoices("한식", "중식", "일식", "양식")));
        itemRepository.save(Item.shortQuestion("생년월일"));
        itemRepository.save(Item.shortQuestion("깃허브"));
        itemRepository.save(Item.shortQuestion("링크드인"));
    }
}